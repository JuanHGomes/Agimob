...
public interface SimulacaoResponseMapper {
    ...
    SimulacaoResponseDto toAmbosResponseDto(Long id, String tipo, List<ParcelaDto> parcelasSac, List<ParcelaDto> parcelasPrice, InformacoesAdicionaisDto informacoesAdicionaisSac, InformacoesAdicionaisDto informacoesAdicionaisPrice );
}